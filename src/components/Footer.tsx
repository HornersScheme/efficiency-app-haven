      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Submit App</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Note Taking</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Team Collaboration</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to get notified about new productivity apps and resources.
            </p>
            <form className="flex flex-col sm:flex-row gap-2">
              <Input 
                type="email" 
                placeholder="Enter your email" 
                className="bg-dark-100 border-dark-200 text-white placeholder:text-gray-400 focus:border-efficiency-400"
              />
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center md:flex md:justify-between md:text-left">
          ...
          <div className="mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-white mx-3 md:ml-6">Terms</a>
            <a href="#" className="text-gray-400 hover:text-white mx-3">Privacy</a>
            <a href="#" className="text-gray-400 hover:text-white mx-3">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
